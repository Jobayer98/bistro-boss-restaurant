...
const Dessert = () => {
  ...
  return (
    <section className="mt-16">
      <Banner className="h-[400px] bg-cover" img={dessertImg}>
        <div className="text-white bg-black bg-opacity-60 w-[70%] mx-auto p-16 ">
          <h1 className="text-3xl font-semibold mb-3 uppercase">Dessert</h1>
          <p className="font-['Inter'] text-sm">
            DESSERTS Lorem Ipsum has been the industry’s standard dummy text
